...
class OperatorNecessarySerializer(serializers.ModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='operator:necessary-detail', lookup_field='uuid',
        read_only=True)
...
class OperatorNecessarySingleSerializer(serializers.ModelSerializer):
    total_count = serializers.IntegerField(read_only=True)
    done_count = serializers.IntegerField(read_only=True)
    skip_count = serializers.IntegerField(read_only=True)
    accept_count = serializers.IntegerField(read_only=True)
...
class OperatorNecessaryFactorySerializer(serializers.ModelSerializer):
